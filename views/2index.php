    ...
    <section id="services" >
        ...
        <div class="container">
            <div class="section-header">
                ...
                <h3>Noticias</h3>
                <p>Confira algumas das novidades. Quer saber mais? <a href="login.php">Confira</a>!</p>
            </div>
...
<br>
        <div class="section-header">
          ...
          <h3>Eventos</h3>
          <p>Aqui estão alguns eventos sobre astronomia que andam rolando no país! Quer saber mais? <a href="login.php">Confira!</a></p>
        </div>
