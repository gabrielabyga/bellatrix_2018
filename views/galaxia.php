    ...
    <div class="well"> 
        <div class="row">
             <div class="col-md-12">
                 ...
                 <div class="">
                     <h1  class="hidden-xs">Galáxias</h1>
                    <hr>
                    <p class="text-justify"> 
                    <a href="galaxia1.php"> <small class="verde"><strong> O que é uma galáxia? </strong></small></a>
                    <hr>
                    <a href="galaxiaAndro.php"> <small class="verde"><strong> Galáxia de Andrômeda </strong></small></a>
                    <hr>
