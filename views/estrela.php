    ...
    <div class="well"> 
        <div class="row">
             <div class="col-md-12">
                 ...
                 <div class="">
                     <h1  class="hidden-xs">Estrelas</h1>
                     <hr>
                    <p class="text-justify"> 
                    <a href="estrela1.php"> <small class="verde"><strong> O que é uma estrela? </strong></small></a>
                    <hr>
                    <a href="sol.php"> <small class="verde"><strong> Sol </strong></small></a>
                    <hr>
                    <a href="cadente.php"> <small class="verde"><strong> Estrela Cadente </strong></small></a>
                    <hr>
